...
class MainActivity305 : AppCompatActivity() {
    ...
    // MainActivity305, MainActivity306, 각각 XML 화면, 샘플 이미지 3장 복사했음.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            val manager = getSystemService(NOTIFICATION_SERVICE) as NotificationManager //<-d이지이를 읽어오기
            ...
            // 그러면, 뒤에 서비스는 아무것도 동작 할수 없습니다.
            // 비동기적 처리를 , 멀티 스레드로 동작을, 병렬 처리 가능.
            // 스레드 업그레이드 -> 경량식 스레드 -> 코루틴 작업을함.
